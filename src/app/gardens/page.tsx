...
function Segmented({
  ...
  return (
    <>
      ...
      <div
        className={`z-30 sticky top-14 md:top-16 transition-all ${
...
export default function GardensPage() {
  ...
  const section = GARDEN_DATA.sections[tab];
